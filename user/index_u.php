...
<!-- header -->
			...
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<div class="w3_navigation_pos">
						<h1><a href="index_u.php"><span>A</span>NC <span>T</span>ravel</a></h1>
					</div>
				</div>
	...
	<li><a href="index_u.php"><i class="fa fa-home" aria-hidden="true"> Home</i></a></li>
	<li><a href="index_u.php?page=plane"><i class="fa fa-plane" aria-hidden="true"> Airplane</i></a></li>
	<li><a href="index_u.php?page=train"><i class="fa fa-train" aria-hidden="true"> Train</a></i></li>
	<li><a href="index_u.php?page=trans"><i class="fa fa-shopping-cart" aria-hidden="true"> Transaction</i></a></li>
	<li><a href="../logout.php"><i class="fa fa-user" aria-hidden="true"> LogOut</i></a></li>
						</ul>
					</nav>
				</div>
			</nav>	
	...
	if(isset($_GET['page'])){
		$hal=($_GET['page']);
		if($hal=="plane"){
			include("../content/booking_plane.php");
		}else if($hal=="trans"){
			include("history.php");
		}else if($hal=="train"){
			include("../content/booking_train1.php");
		}
